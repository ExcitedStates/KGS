...
//    if(arg=="--residueNetwork" || arg=="-res"){ Util::split( argv[++i],',',residueNetwork);    continue; }
	...
	if( hydrogenbondMethod!="user" && hydrogenbondMethod!="dssr" && hydrogenbondMethod!="rnaview" && hydrogenbondMethod!="first" && hydrogenbondMethod!="FIRST" && hydrogenbondMethod!="vadar" && hydrogenbondMethod!="kinari" && hydrogenbondMethod!="KINARI" && hydrogenbondMethod!="identify"){
//		enableLogger("so");
