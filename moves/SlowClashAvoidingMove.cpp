...
#include "SlowClashAvoidingMove.h"
...
SlowClashAvoidingMove::SlowClashAvoidingMove() :
...
Configuration* SlowClashAvoidingMove::performMove(Configuration* current, gsl_vector* gradient) {
...
gsl_matrix* SlowClashAvoidingMove::computeClashAvoidingJacobian(Configuration* conf, set< std::pair<Atom*,Atom*> >& allCollisions) {
