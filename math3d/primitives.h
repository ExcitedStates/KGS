...
class RigidTransform
{
 public:
  ...
  inline void get(Matrix4&) const;
  void get(Real m[16]) const; // Row major, for post multiplication
  void getGL(Real m[16]) const; // Column major, for post multiplication
...
inline void Vector2::setMinimum(const Vector2& a,const Vector2& b) { set(std::min(a.x,b.x),std::min(a.y,b.y)); }
inline void Vector2::setMaximum(const Vector2& v) { if(v.x>x) x=v.x; if(v.y>y) y=v.y; }
inline void Vector2::setMaximum(const Vector2& a,const Vector2& b) { set(std::max(a.x,b.x),std::max(a.y,b.y)); }
...
inline void Vector3::setMinimum(const Vector3& a,const Vector3& b) { set(std::min(a.x,b.x),std::min(a.y,b.y),std::min(a.z,b.z)); }
inline void Vector3::setMaximum(const Vector3& v) { if(v.x>x) x=v.x; if(v.y>y) y=v.y; if(v.z>z) z=v.z; }
inline void Vector3::setMaximum(const Vector3& a,const Vector3& b) { set(std::max(a.x,b.x),std::max(a.y,b.y),std::max(a.z,b.z)); }
...
inline void Vector4::setMinimum(const Vector4& a,const Vector4& b) { set(std::min(a.x,b.x),std::min(a.y,b.y),std::min(a.z,b.z),std::min(a.w,b.w)); }
inline void Vector4::setMaximum(const Vector4& v) { if(v.x>x) x=v.x; if(v.y>y) y=v.y; if(v.z>z) z=v.z; if(v.w>w) w=v.w; }
inline void Vector4::setMaximum(const Vector4& a,const Vector4& b) { set(std::max(a.x,b.x),std::max(a.y,b.y),std::max(a.z,b.z),std::max(a.w,b.w)); }
