...
void DisjointSets::Union(int elemId1, int elemId2)
{
  int setId1 = FindSet(elemId1);
  int setId2 = FindSet(elemId2);
  ...
  // union, the node with the higher rank is made the m_parent of the one with the lower rank and
