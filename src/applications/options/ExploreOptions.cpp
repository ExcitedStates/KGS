...
void ExploreOptions::initializeVariables(){
...
void ExploreOptions::printUsage(char* pname){
...
inline bool ExploreOptions::fileExists (const std::string& name) {
...
ExploreOptions* ExploreOptions::instance = nullptr;

ExploreOptions* ExploreOptions::getOptions()
{
  if(instance==nullptr) {
    cerr << "ExploreOptions::getInstance - Sampling options haven't been initialized"<<endl;
    throw "ExploreOptions::getInstance - Sampling options haven't been initialized";
  }

  return instance;
}

ExploreOptions* ExploreOptions::createOptions(int argc, char* argv[] )
{
  if(instance!=nullptr) {
    delete instance;
  }
  instance = new ExploreOptions(argc, argv);
  return instance;
}

ExploreOptions* ExploreOptions::createOptions()
{
  if(instance!=nullptr) {
    delete instance;
  }
  instance = new ExploreOptions();
  return instance;
}
